...
def main() -> int:
    ...
    parser.add_argument("--extension", default="ГСК_СчетОферта")
    parser.add_argument("--src", default="src")
    parser.add_argument("--out", default=r"dist\ГСК_СчетОферта.cfe")
    ...
    if not args.server or not args.ref:
        raise ValueError(
            "Set infobase with --server/--ref or environment variables ONEC_SERVER/ONEC_REF."
        )
